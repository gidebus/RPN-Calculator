...
describe('Calculator', () => {
  ...
  test('Invalid operator is used', () => {
    calc.push(3);
    expect(() => calc.calculate('$')).toThrow('Unknown operator: $');
  })

  test('Not enough operands given', () => {
    calc.push(3);
    expect(() => calc.calculate('+')).toThrow('Not enough operands');
  })
  ...
  describe('Division', () => {
    ...
    test('Division by zero', () => {
      calc.push(25);
      calc.push(0);
      expect(() => calc.calculate('/')).toThrow('Division by zero is not allowed');
    })
